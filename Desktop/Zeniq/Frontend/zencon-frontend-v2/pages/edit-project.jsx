                    ...
                    <Container>
                        <div className="text-center pb-4 w-max-[50vw]">
                            <div className="flex flex-row justify-between">
                                <div>
                                    <h1 className="mt-40 text-6xl font-extrabold text-left text-white capitalize font-primary">
                                        You can edit <span
                ...
                <div className='w-full bg-white'>
                    <div className="container mx-auto bg-white">
                        ...
                        <div className="w-full max-w-full">
                            <form className="px-8 pt-6 pb-8 bg-white rounded shadow-md">
                                <ProjectInfoFields {...projectInfoProps} />
                                <hr/>
                                <p className="mt-6 text-2xl text-center text-black">Who else is in the project?</p>
