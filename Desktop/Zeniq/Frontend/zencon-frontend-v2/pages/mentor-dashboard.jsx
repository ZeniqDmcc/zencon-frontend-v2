        ...
        <>
            ...
            <main className="relative min-h-screen overflow-hidden page-wrapper">
                ...
                <div className='w-full bg-white'>
                    <div className="container mx-auto bg-white projecs-listed">
                        <h1 className="mt-10 mb-8 text-3xl font-extrabold text-left text-gray-900 font-primary">
                            PublicProjects Listed
                        </h1>
                        <div
                            className="grid grid-cols-1 mb-12 lg:grid-cols-3 sm:grid-cols-2 justify-items-center gap-14">
                                ...
                                <div className="w-full height-full" key={index}>
                                    <div
                                        ...
                                        <div className="flex flex-col justify-between">
                                            ...
                                            <h2 className="px-4 text-justify text-gray-400 opacity-100 text-md">{item.shortDescription}</h2>
