...
export default function MoreInfoOrg() {
  return (
    <div className="flex flex-col gap-[35px]">
      {MoreInfoOrgContent &&
        MoreInfoOrgContent.map((item) => {
          return (
            <div key={nanoid()} className="relative list-disc">
              <div className="lg:before-circle lg:absolute lg:h-3.5 lg:w-3.5 lg:rounded-full lg:border-2 lg:border-[#87FF4F] lg:bg-[#010020] lg:left-[-38px] lg:top-2"></div>
              <MoreInformation
...
const MoreInfoOrgContent = [
  ...
  },
  {
    ...
    paragraphText:
      "The top 200 registrants will be selected to participate at ZENCON Rio 2023.",
  },
  {
