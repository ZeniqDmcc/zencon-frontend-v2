        ...
        <div className="container mx-auto">
            <div className="flex justify-between lg:gap-0 gap-0 flex-col lg:flex-row">
                <div className="lg:flex-1 lg:order-1 order-2 flex flex-col lg:m-10" key={nanoid()}>
                    <h2 className="xl:text-5xl lg:text-4xl md:text-2xl text-xl font-medium text-green-400 leading-16 lg:text-left text-center sm:py-8 pt-8 pb-0">{props.title}</h2>
