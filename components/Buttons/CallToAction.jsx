        ...
        newTab ?
            ...
            <Link href={{
                ...
                <button
                    onClick={onClick}
                    disabled={disabled}
                    className={`capitalize hover:bg-[#030423] ${active ? "bg-[#00223C]" : "bg-[#00223C]"} transition-colors disabled:bg-black px-6 
                  text-white py-2 rounded-md text-uppercase text-sm font-medium font-poppins border-[2px] border-opacity-18 border-[#A1E285]  sm:w-auto ${classes}`}
                >
                    {text}
                </button>
            </Link>
