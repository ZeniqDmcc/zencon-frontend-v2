    ...
    return (
      <div className="flex items-end justify-center" key={nanoid()}>
          <div className="container">
            <div className="flex items-end justify-center pt-[580px] 640px:pt-[300px]">
                <div className="flex flex-col items-center gap-4 lg:gap-10 sm:gap-5">
                    <span className='px-2 text-2xl xl:text-4xl l md:text-3xl sm:text-2xl text-center font-medium tracking-tighter text-green-400 z-10'>September 16 - 21, 2023</span>
                    <h1 className="w-3/5 text-2xl xl:text-6xl lg:text-5xl md:text-4xl sm:text-3xl font-medium text-center tracking-tight text-white-400 z-10">{props.title}</h1>
                    ...
                    <div className="flex flex-col md:flex-row sm:mt-3 gap-4 mt-2">
