            ...
            <div className="flex items-end justify-center h-screen">
                <div className="flex flex-col items-center gap-4 lg:gap-10 sm:gap-5">
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                        <Button label='Participate' href={redirectUrl}/>
...
Banner.defaultProps = {
    ...
    description: "Are you ready to take on the challenge and compete against some of the world's most innovative developers? ZENCON Rio 2023 is the perfect opportunity to showcase your skills and make a name for yourself in the world of blockchain and finance. With a prize pool of $100,000 USD up for grabs, the competition is fierce and the stakes are high."
}
